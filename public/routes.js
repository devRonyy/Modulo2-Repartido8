...
router.post('/comentarios',(req, res)=>{
    ...
    res.json({Mensaje:` <div class = "nombre"> ${nombre} <img src="../huella.png" class="img-coment"> </div> <div class = "comentario"> ${comentario} </div> <div class="eliminar"><button type="button" onClick="eliminarDiv(this)"  class="btn">X</button></div>`})
})
